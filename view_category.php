...
$catInfo = $rest->get('http://ec2-52-14-250-16.us-east-2.compute.amazonaws.com:3000/category/');
...
<aside id="left-panel"> 
  ...
  <nav> 
    ...
    <ul>
	  ...
	  <!--<li><a href="view_users.html"><i class="fa fa-cog"></i> <span class="menu-item-parent">System Settings</span></a></li>-->
      </ul>
  </nav>
    ...
    <div class="row"> 
      ...
      <div class="col-xs-12 col-sm-7">
        <h1 class="page-title txt-color-blueDark"> 
          ...
          <!-- PAGE HEADER --> 
          <i class="fa-fw fa fa-clipboard"></i> District <!--<strong>View Clients</strong>--> </h1>
      </div>
      <!-- end col --> 
          ...
          <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-sortable="false" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false"> 
            ...
            <div> 
              ...
              <div class="widget-body">
                <div class="row">
                  <div class="col col-lg-8 col-md-10 col-sm-8 col-xs-12">
              ...
              <br>
			   <div class="widget-body no-padding">
                <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
                  ...
                  <tbody>
				  <?php for($x=0; $x < count($catInfo); $x++ ){
					  ?>
                    <tr>
                      <td><?php echo $catInfo[$x]->name ?></td>
                      <td><?php echo $catInfo[$x]->areaId ?></td>
                     </tr>
				  <?php } ?>
                  </tbody>
                </table>
