...
if($_POST)
{
	...
	if($name == ""){
		...
		$data['name'] = $name;
		$area = $rest->post('http://ec2-52-14-250-16.us-east-2.compute.amazonaws.com:3000/area/','',$data);
		
		if($area->success == true)
		{
    ...
    <div class="row"> 
      ...
      <div class="col-xs-12 col-sm-7">
        <h1 class="page-title txt-color-blueDark"> 
          ...
          <!-- PAGE HEADER --> 
          <i class="fa-fw fa fa-clipboard"></i> Area <!--<strong>Add Client</strong>--> </h1>
      </div>
      <!-- end col --> 
